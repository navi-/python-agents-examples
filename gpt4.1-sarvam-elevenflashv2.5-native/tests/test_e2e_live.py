"""
End-to-end live tests for the GPT-4.1 Mini + Sarvam + ElevenLabs voice agent.
...
Requirements:
    - Valid OPENAI_API_KEY, SARVAM_API_KEY, ELEVENLABS_API_KEY in .env
...
Usage:
    cd gpt4.1-sarvam-elevenflashv2.5-native

...
class TestLiveCall:
    ...
    def test_live_call_two_way_conversation(self, plivo_configured):
        """Place a call, ask the agent a question via Plivo TTS, verify response."""
        client = plivo_configured["client"]
        public_url = plivo_configured["public_url"]
        ...
        try:
            ...
            client.calls.speak(
                call_uuid, text=question, language="en-US", legs="aleg"
            )
        ...
        greeting_words = [
            "hello", "hi", "welcome", "help", "how", "alex", "techflow",
        ]

"""
Integration tests for GPT-4o Deepgram OpenAI-TTS Pipecat Voice Agent.
...
3. OpenAI Integration - Test OpenAI API connection
...
class TestOpenAIIntegration:
    ...
    async def test_openai_chat_completion(self, openai_configured):
        """Test basic OpenAI Chat Completion API connection."""
        import openai

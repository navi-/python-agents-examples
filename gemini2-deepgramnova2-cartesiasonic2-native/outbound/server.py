...
app = FastAPI(
    title="Gemini-Deepgram-Cartesia Voice Agent (Outbound)",
    description="Outbound voice agent using Gemini LLM, Deepgram STT, and Cartesia TTS",
    version="0.1.0",
)
...
async def health_check() -> dict:
    ...
    return {
        "status": "ok",
        "service": "gemini2-deepgramnova2-cartesiasonic2-voice-agent-outbound",

...
app = FastAPI(
    title="GPT-4o Deepgram OpenAI-TTS Pipecat Voice Agent (Outbound)",
    description=(
        "Outbound voice agent using GPT-4o-mini LLM, Deepgram STT, "
...
async def health_check() -> dict:
    ...
    return {
        "status": "ok",
        "service": "gpt4o-deepgramnova3-openaitts4o-pipecat-outbound",

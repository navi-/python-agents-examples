"""
End-to-end live tests for the GPT-4o Deepgram OpenAI-TTS Pipecat voice agent.
...
Requirements:
    - Valid OPENAI_API_KEY and DEEPGRAM_API_KEY in .env
...
Usage:
    cd gpt4o-deepgramnova3-openaitts4o-pipecat
...
pytestmark = pytest.mark.skipif(
    not OPENAI_API_KEY or not DEEPGRAM_API_KEY,
    reason="OPENAI_API_KEY or DEEPGRAM_API_KEY not configured",
)

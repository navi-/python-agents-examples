"""
End-to-end live tests for the GPT-AssemblyAI-Cartesia voice agent.
...
Requirements:
    - Valid OPENAI_API_KEY, ASSEMBLYAI_API_KEY, CARTESIA_API_KEY in .env
...
pytestmark = pytest.mark.skipif(
    not all([OPENAI_API_KEY, ASSEMBLYAI_API_KEY, CARTESIA_API_KEY]),
    reason="OPENAI_API_KEY, ASSEMBLYAI_API_KEY, or CARTESIA_API_KEY not configured",
)

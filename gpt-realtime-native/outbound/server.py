...
app = FastAPI(
    title="GPT Realtime-Plivo Voice Agent (Outbound)",
    description="Outbound voice agent using OpenAI GPT Realtime with Plivo telephony",
    version="0.1.0",
)
...
async def health_check() -> dict:
    ...
    return {
        "status": "ok",
        "service": "gpt-realtime-plivo-voice-agent-outbound",
...
def main() -> None:
    ...
    logger.info(f"Starting GPT Realtime-Plivo Outbound Voice Agent on port {SERVER_PORT}")

...
try:
    ...
    Traceloop.init(app_name="gpt4.1mini-gpt4.1-deepgramnova3-elevenflashv2.5-native")
...
async def health_check() -> dict:
    ...
    return {
        "status": "ok",
        "service": "gpt4.1mini-gpt4.1-deepgramnova3-elevenflashv2.5-voice-agent-outbound",

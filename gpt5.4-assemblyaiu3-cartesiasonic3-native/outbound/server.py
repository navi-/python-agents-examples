...
app = FastAPI(
    title="GPT-AssemblyAI-Cartesia Voice Agent (Outbound)",
    description="Outbound voice agent: GPT-5.4-mini + AssemblyAI STT + Cartesia TTS + Plivo",
    version="0.1.0",
)
...
async def health_check() -> dict:
    ...
    return {
        "status": "ok",
        "service": "gpt-assemblyai-cartesia-voice-agent-outbound",
...
def main() -> None:
    ...
    logger.info(f"Starting GPT-AssemblyAI-Cartesia Outbound Voice Agent on port {SERVER_PORT}")

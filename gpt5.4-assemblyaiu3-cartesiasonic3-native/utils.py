...
- Pipeline converters for AssemblyAI and Cartesia
"""
...
ASSEMBLYAI_SAMPLE_RATE = 16000  # AssemblyAI expects 16kHz PCM16
CARTESIA_SAMPLE_RATE = 24000  # Cartesia TTS output at 24kHz PCM16
...
def plivo_to_assemblyai(mulaw_8k: bytes) -> bytes:
    """Convert Plivo audio (μ-law 8kHz) to AssemblyAI format (PCM16 16kHz)."""
    pcm_8k = ulaw_to_pcm(mulaw_8k)
    return resample_audio(pcm_8k, PLIVO_SAMPLE_RATE, ASSEMBLYAI_SAMPLE_RATE)

...
Your tech stack:
- STT: AssemblyAI (real-time speech-to-text)
...
components: AssemblyAI for speech recognition, OpenAI GPT-5.4-mini for language
processing, Cartesia for voice synthesis, LiveKit for orchestration, and Plivo
for telephony.

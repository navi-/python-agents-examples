"""Inbound voice agent — Gemini LLM + Deepgram STT + ElevenLabs TTS.
...
class VoiceAgent:
    ...
    async def run(self) -> None:
        ...
        try:
            ...
            greeting = (
                "Hello! This is Alex, the Gemini-Deepgram-ElevenLabs "
                "native agent. "
    ...
    async def _receive_from_deepgram(self) -> None:
        ...
        # Deepgram transcripts are handled by DeepgramSTT._receive_loop
        # which calls _handle_transcript. This task keeps alive until stopped.
        try:
            while self._running:

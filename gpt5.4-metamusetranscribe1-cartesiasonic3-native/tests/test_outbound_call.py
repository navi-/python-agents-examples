...
Requirements:
    - Valid PLIVO_AUTH_ID, PLIVO_AUTH_TOKEN, PLIVO_PHONE_NUMBER, PLIVO_TEST_NUMBER,
      OPENAI_API_KEY, META_API_KEY, CARTESIA_API_KEY in .env
...
def bleg_app_id(plivo_client, ngrok_tunnel):
    ...
    app_name = "Babel_Muse_Outbound_Test"
...
class TestOutboundCall:
    ...
    def test_initiate_outbound_call_api(self, server_process, ngrok_tunnel):
        ...
        resp = httpx.post(
            ...
            params={
                ...
                "opening_reason": "your group booking for tonight at Bistro Mundo",
                "objective": "confirm the head count and read back the pre-order",
            },
            timeout=30.0,
        )
    ...
    def test_outbound_call_status_lifecycle(self, server_process, ngrok_tunnel, bleg_app_id):
        ...
        resp = httpx.post(
            ...
            params={
                "phone_number": PLIVO_TEST_NUMBER,
                "opening_reason": "your open group order at Bistro Mundo",
            },
            timeout=30.0,
        )
        data = resp.json()
